...
export function useAllV3Routes(
  ...
  return useMemo(() => {
    ...
    //Hack
    const singleIfWrapped = (currencyIn.isNative && currencyOut.address === '0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83') || (currencyIn.address === '0x21be370d5312f44cb42ce377bc9b8a0cef1a4c83' && currencyOut.isNative)
